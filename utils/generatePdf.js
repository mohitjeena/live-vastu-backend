...
function generateAiReportHtml(aiHtml) {
  ...
  <path fill="#241F21" d="M152 49h3v10h-3zM184 4h3v5l-3 1z"/><path fill="#241F20" d="M55 14h3v3h-3z"/></svg>`;
...
<head>
  ...
  <style>
    * {
    ...
    .page-footer-fixed .divider-line {
      border-top: 1px solid #dcd5cc;
      margin-bottom: 6px;
      width: 100%;
    }
    .page-footer-fixed .footer-items {
      display: flex;
    ...
    .page-footer-fixed .footer-items a {
      color: #D60000;
      font-size: 12.5px;
      font-weight: bold;
      text-decoration: none;
    }
    /* Table structure ensures content never collides with header/footer */
    .report-table {
      width: 100%;
      border-collapse: collapse;
      background-color: #f7f3ef;
    }
    .report-table-header-space {
      height: 98px;
    }
    .report-table-footer-space {
      height: 90px;
    }
    .report-content-cell {
      padding: 0 40px;
    ...
    .ai-report-flow h2 {
      ...
      margin-bottom: 10px;
      padding-bottom: 5px;
      border-bottom: 1.5px solid #C88200;
      letter-spacing: 0.2px;
      page-break-after: avoid;
      break-after: avoid;
    }
...
<body>
  <!-- 1. Full Page 5px Red Border on EVERY page -->
  <div class="page-border-frame"></div>

  <!-- 2. Fixed Header on EVERY page -->
  ...
  <!-- 3. Fixed Footer on EVERY page -->
  <div class="page-footer-fixed">
    <div class="divider-line"></div>
    <div class="footer-items">
      <span>WEB: <br><b><a href="https://livevaastu.in/" target="_blank">livevaastu.in</a></b></span>
      <span>EMAIL: <br><b><a href="mailto:contact@livevaastu.com">contact@livevaastu.com</a></b></span>
      <span>MOBILE: <br><b><a href="tel:9555666667">95556 66667</a></b></span>
    </div>
  </div>

  <!-- 4. Paged content with auto-repeating header/footer spacing -->
  <table class="report-table">
    <thead>
      <tr>
        <td style="border:none; padding:0;"><div class="report-table-header-space"></div></td>
      </tr>
    </thead>
    <tbody>
      <tr>
    ...
    <tfoot>
      <tr>
        <td style="border:none; padding:0;"><div class="report-table-footer-space"></div></td>
      </tr>
    </tfoot>
  </table>
</body>
